...
attribute @s minecraft:max_health base set 74
data merge entity @s {Health:74.0f,DeathLootTable:"wsm:entities/piglin_brute_tier_5"}
data merge entity @s {CustomNameVisible:1b,CustomName:{text:"Brute infernale",color:"gold",bold:true}}
