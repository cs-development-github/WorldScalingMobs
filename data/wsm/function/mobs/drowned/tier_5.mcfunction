...
data merge entity @s {Health:52.0f,DeathLootTable:"wsm:entities/drowned_tier_5"}
data merge entity @s {CustomNameVisible:1b,CustomName:{text:"Noye des abysses",color:"dark_aqua",bold:true}}
