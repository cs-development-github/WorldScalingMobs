...
data merge entity @s {Health:64.0f,DeathLootTable:"wsm:entities/vindicator_tier_5"}
data merge entity @s {CustomNameVisible:1b,CustomName:{text:"Bourreau",color:"dark_red",bold:true}}
